...
var commands = exports.commands = {
	...
	groups: function(target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('± <b>Gym Leader</b> - These are the Gym Leaders of the server. <br />' +
		        '$ <b>Champion</b> - They are the champion of one of the Amethyst League Tiers. They can use some ! commands.<br />' +
	...
	avatars: function(target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('Your avatar can be changed using the Options menu (it looks like a gear) in the upper right of Pokemon Showdown. <br />Voice and above may also request a custom avatar by messaging a Leader or Administrator.');
	},
	...
	rules: function(target, room, user) {
		...
		this.sendReplyBox('Please follow the rules:<br />' +
			'- <a href="http://amethyst-server.no-ip.org/rules.html">Rules</a><br />' +
			'</div>');
	},
